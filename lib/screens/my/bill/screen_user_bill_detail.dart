...
class UserBillDetailScreen extends StatefulWidget {
  const UserBillDetailScreen({super.key, required this.billItem});
  final BillItem billItem;

  @override
  State<UserBillDetailScreen> createState() => _UserBillDetailScreenState();
}

class _UserBillDetailScreenState extends State<UserBillDetailScreen> {
  @override
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 10),
                            Text('Cửa hàng: ${widget.billItem.shopName}',
                                style: const TextStyle(
                                    fontSize: 22,
                                    color: buttonBackgroundColor,
                                    fontWeight: FontWeight.bold)),
