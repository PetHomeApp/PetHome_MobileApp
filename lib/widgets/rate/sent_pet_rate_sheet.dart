...
class SendPetRateWidget extends StatefulWidget {
  final String petId;
  const SendPetRateWidget({super.key, required this.petId});

  @override
  // ignore: library_private_types_in_public_api
  _SendPetRateWidgetState createState() => _SendPetRateWidgetState();
}

class _SendPetRateWidgetState extends State<SendPetRateWidget> {
